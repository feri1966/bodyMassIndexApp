...
const App: React.FC = () => {
  ...
  const calculateBMI = () => {
    ...
    if (
      ...
      setError('Kérlek adj meg valós(nem negatív) számot!');
      return;
    }
  ...
  return (
      ...
      <IonApp>
        <IonHeader>
          <IonToolbar color="primary">
            <IonTitle>Test-tömeg-index</IonTitle>
          </IonToolbar>
        </IonHeader>
              ...
              <IonCol>
                ...
                <IonItem>
                  <IonLabel position="floating">
                    Magasságod ({calcUnits === "mkg" ? 'méter' : 'feet'})
                  </IonLabel>
    ...
    <IonFooter className="ion-no-border ion-text-center">
      <IonToolbar>
        <IonTitle>created by © Buzsgi </IonTitle>
      </IonToolbar>
    </IonFooter>
